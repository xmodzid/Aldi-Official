...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { name: 'google-adsense-account', content: 'ca-pub-3135834444356256' }],

    // Google AdSense Script
    ['script', {
      async: 'true',
      src: 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3135834444356256',
